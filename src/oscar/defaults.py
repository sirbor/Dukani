...
OSCAR_SHOP_NAME = "Dukani"
OSCAR_SHOP_TAGLINE = "Excellence in Timekeeping"
# Storefront landing (HomeView), not catalogue browse — avoids broken "home" links site-wide
...
# Maximum inclusive span (days) for the dashboard sales chart date picker.
OSCAR_DASHBOARD_SALES_CHART_MAX_DAYS = 366
...
OSCAR_CATALOGUE_USE_POSTGRES_MATERIALISED_VIEWS = False
