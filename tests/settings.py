...
# SQLite + Whoosh realtime indexing can hang on bulk saves (e.g. fixtures); CI uses Postgres + realtime.
_database_engine = os.environ.get("DATABASE_ENGINE", "django.db.backends.postgresql")
if _database_engine.endswith("sqlite3"):
